...
.footer{
  ...
  <%
      Connection con=null;
      Statement st=null;
      String nam=request.getParameter("nu");
      session.setAttribute("naam",nam);
      try{
          Class.forName("com.mysql.jdbc.Driver");
                con=DriverManager.getConnection("jdbc:mysql://localhost:3306/ju", "root","root");
                st=con.createStatement();
                String sql="SELECT * FROM bankdetails WHERE name='"+nam+"'";
          ...
          <%
                while(rt.next())
                {
                   ...
                   <form style="text-align: center" action="money.jsp">
                         <h2 style="font-size: 35px; color: #990073 ">Customer details</h2>
                         <b>  <h3><%= ""+nam %> </h3></b><br>
                   ...
                   <label><b>Current Balance=</b></label>
                    ...
                    <br>
                    <br>
                        <button class="button">Transfer money
                        </button>
                    <br>
                    <br>
                    </form>
