...
tr:nth-child(odd) {
  background-color: #f1f1f1;
    ...
    <div class="dropdown-content">
        ...
        <h2 style="text-align: center">Transaction details are as follows:</h2>
  ...
  <%
      ...
      try{
          Class.forName("com.mysql.jdbc.Driver");
                ...
                String sql="SELECT * FROM transrecords";
    ...
    <th>Date and Time</th>
          ...
          <%
                while(rt.next())
                {
                    String date=rt.getString("datetime");
                    String info=rt.getString("sender");
                 
                    String bal=rt.getString("amount");
                    out.println("<tr><td>"+info+"</td><td>"+bal+"</td><td>"+date+"</td></tr>");
      ...
      <form action='index.html'>
          <button  class="button" style="text-align: center">Okay!</button>
      </form>
