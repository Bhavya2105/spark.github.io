...
.footer{
    ...
    <div class="dropdown-content">
        ...
        <form action="tablerecord.jsp" style="text-align: center">
            <h1 style="font-size: 35px; color: #990073">Pay</h1><br>
        <span style='font-size:60px;'>&#8377;</span><input  class="box" type="text" name="p1"><br><br>
